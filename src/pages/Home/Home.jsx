  ...
  return (
    <main className={Styles["home"]}>
      <section className={Styles["home__popular-releases"]}>
        <PagePartition text="popular releases" width={"30%"} />
        <RollSection>
          {albums?.map((album) => (
            <AlbumCard
              key={album.id}
      ...
      <section className={Styles["home__about-tapeworm"]}>
        ...
        <div className={Styles["feature-block"]}>
          <div className={Styles["feature-block__content"]}>
            ...
            <p className={Styles["feature-block__text"]}>
              Explore your favorite music genre in all its variations. We have a
              total of (x) music genres and subgenres available in our database.
            </p>
          </div>
          <div className={Styles["feature-block__image-container"]}>
            <img
              src={genresPrint}
              alt=""
              className={Styles["feature-block__image"]}
            />
          </div>
        </div>

        <div
          className={`${Styles["feature-block"]} ${Styles["feature-block--reverse"]}`}
        >
          <div className={Styles["feature-block__content"]}>
            <h2 className={Styles["feature-block__title"]}>
            ...
            <p className={Styles["feature-block__text"]}>
              Create your own record collection, whether it's records you've
              already listened to or those you still want to listen to! We have
              several different types of lists you can use.
            </p>
          </div>
          <div className={Styles["feature-block__image-container"]}>
            <img
        ...
        <div className={Styles["feature-block"]}>
          <div className={Styles["feature-block__content"]}>
            ...
            <p className={Styles["feature-block__text"]}>
              Feel free to geek on your favourite records writing your own
              essays on them!
            </p>
          </div>
          <div className={Styles["feature-block__image-container"]}>
            <img
              src={releasePagePrint}
              alt=""
              className={Styles["feature-block__image"]}
            />
          </div>
        ...
        >
          <div className={Styles["feature-block__content"]}>
            ...
            <p className={Styles["feature-block__text"]}>
              Receive recommendations, see what the users you follow are
              listening to, and interact with them through our personalized
              feed.
            </p>
          </div>
          <div className={Styles["feature-block__image-container"]}>
